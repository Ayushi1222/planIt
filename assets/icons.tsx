...
export const NotesIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M15.25 8.75L12 12l-3.25-3.25"/><path d="M12 2a10 10 0 100 20 10 10 0 100-20z"/><path d="M8 12h8"/></svg>
);
...
export const PlansIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
export const PriceIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><line x1="12" y1="2" x2="12" y2="22" /><path d="M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6" /></svg>
);
...
export const ArtIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12.5 2.5a.5.5 0 00-1 0V7l-2 3-2-3V2.5a.5.5 0 00-1 0V11l4 5 4-5V2.5a.5.5 0 00-1 0V7l-2 3-2-3V2.5z"/><path d="M12 16v6"/><path d="M17 22H7"/></svg>
);
export const HeritageIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M3 22h18"/><path d="M5 22V8l7-5 7 5v14"/><path d="M12 18h.01"/><path d="M12 15h.01"/><path d="M12 12h.01"/><path d="M12 9h.01"/></svg>
);
export const LiveMusicIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
export const NatureIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M17.5 11.5c.9-1.3 1.4-2.8 1.4-4.5 0-3.9-3.1-7-7-7s-7 3.1-7 7c0 1.7.5 3.2 1.4 4.5"/><path d="M12 22V8"/><path d="M5 12h14"/></svg>
);
export const NightlifeIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M21 12.79A9 9 0 1111.21 3 7 7 0 0021 12.79z"></path></svg>
);
export const ShoppingIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"></path><line x1="3" y1="6" x2="21" y2="6"></line><path d="M16 10a4 4 0 0 1-8 0"></path></svg>
);
export const SpecialEventIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
export const DiningIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M3 2v7c0 1.1.9 2 2 2h4a2 2 0 002-2V2"/><path d="M17 2v7c0 1.1.9 2 2 2h4a2 2 0 002-2V2"/><path d="M12 11v11"/><path d="M7 22h10"/></svg>
);
export const OutdoorsIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 2L2 22h20L12 2z"/></svg>
);
export const RelaxingIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M4 12c-2.2-2.2-2.2-5.8 0-8 .5-.5 1.2-.8 1.9-.9C7.4 2.6 9 3.4 10 4c1.1.7 2.2 1.1 3.4 1.1 1.2 0 2.3-.4 3.4-1.1.9-.6 2.6-1.4 4.1-.9.7.1 1.4.4 1.9.9 2.2 2.2 2.2 5.8 0 8-.5.5-1.2.8-1.9.9-1.5.5-3.2-.3-4.1-.9-1.1-.7-2.2-1.1-3.4-1.1-1.2 0-2.3.4-3.4 1.1-.9.6-2.6 1.4-4.1.9-.7-.1-1.4-.4-1.9-.9z"/><path d="M12 12v10"/><path d="M12 22h.01"/></svg>
);
...
export const FamilyIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 12c-2.67 0-5 1.33-5 4v2h10v-2c0-2.67-2.33-4-5-4zm0-10c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z"/><path d="M20 12c-1.1 0-2 .9-2 2v2h4v-2c0-1.1-.9-2-2-2zm-2-8c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zM4 12c-1.1 0-2 .9-2 2v2h4v-2c0-1.1-.9-2-2-2zM4 4c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z"/></svg>
);
export const CultureIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M4 22h16"/><path d="M6 18h12"/><path d="M10 18v-5l-2-2v-1h8v1l-2 2v5"/><path d="M12 5l-2-2h4l-2 2z"/></svg>
);
